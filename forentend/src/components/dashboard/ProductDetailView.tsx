...
export function ProductDetailView({ product, suggestions }: ProductDetailViewProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xs text-muted-foreground">
              {inventoryData.onOrder} units on order
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="sales" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sales, revenue, and profit trends over the past 12 months
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="inventory" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track current stock levels and inventory metrics
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {productSuggestions.map(suggestion => (
              <InsightCard
                ...
                badgeVariant={suggestion.difficulty === "easy" ? "default" : suggestion.difficulty === "medium" ? "secondary" : "outline"}
                footer={
